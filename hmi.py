...
class FullScreenApp:
    def __init__(self, master, **kwargs):
        ...
        # Load the background images and get the window size
        ...
        button1 = self.create_round_button("", "Button 1", x=100, y=100)
        button1.place(x=300, y=350)

        button2 = self.create_round_button("", "Button 2", x=300, y=100)
        button2.place(x=1100, y=350)

        button3 = self.create_round_button("", "Button 3", x=500, y=100)
        ...
        self.button2 = tk.Button(master, image=self.image1, bd=0, highlightthickness=0, command=lambda: self.on_image_click(2))
        self.button2.place(x=300, y=350)

        
        self.button2 = tk.Button(master, image=self.image3, bd=0, highlightthickness=0, command=lambda: self.on_image_click(2))
        self.button2.place(x=1100, y=350)
